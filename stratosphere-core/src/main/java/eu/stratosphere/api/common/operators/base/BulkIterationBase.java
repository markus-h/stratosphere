...
public class BulkIterationBase<T> extends SingleInputOperator<T, T, AbstractFunction> implements IterationOperator {
	...
	public <X> void setTerminationCriterion(Operator<X> criterion) {
		...
		this.registerConvergenceCriterion(TERMINATION_CRITERION_ACCUMULATOR_NAME, TerminationCriterionAccumulationConvergence.class);
	}
	
	
	public void registerConvergenceCriterion(String nameOfAccumulator, Class<? extends ConvergenceCriterion<?>> convergenceCheck)
	{
	...
	public static class TerminationCriterionMapper<X> extends AbstractFunction implements Serializable, GenericCollectorMap<X, Nothing> {
		...
		public void open(Configuration parameters) {
			...
			getIterationRuntimeContext().addAccumulator(TERMINATION_CRITERION_ACCUMULATOR_NAME, accumulator);
		}

...
//			this.singleRoot.setInputs(new PactConnection(nextPartialSolution, this.singleRoot, -1), new PactConnection(terminationCriterion, this.singleRoot, -1));
			...
			this.rootConnection = new PactConnection(nextPartialSolution, singleRootJoiner, -1);
			this.terminationCriterionRootConnection = new PactConnection(terminationCriterion, singleRootJoiner, -1);

...
public class IterationTerminationWithTerminationIntermediate extends TestBase2 {
	...
	public IterationTerminationWithTerminationIntermediate(Configuration config) {
		super(config);
	}
